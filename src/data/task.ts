 ...
 *
 * Deciding WHICH notifications to arm is not here: that is the canonical
 * reminder module (data/reminderPlan.ts), reached through lib/reminderAdapter.
 */
...
export function makeTask(
  ...
  return {
    ...
    reminderLeadDays: clampLeadDays(fields.reminderLeadDays ?? DEFAULT_LEAD_DAYS),
    reminderRepeatDays:
